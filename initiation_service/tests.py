...
from initiation_service.consumers.initiation_queue_consumer import InitiationQueueConsumer
from initiation_service.lib.utils.logger import log


class InitiationQueueConsumerTest(TestCase):
    """Test cases for the InitiationQueueConsumer"""
    
    def setUp(self):
        """Set up test fixtures"""
        self.consumer = InitiationQueueConsumer()
    ...
    def test_consumer_initialization(self):
        ...
        self.assertIsInstance(self.consumer, InitiationQueueConsumer)
        self.assertEqual(self.consumer.stream_name, "initiation_queue")
        self.assertEqual(self.consumer.consumer_group, "initiation_service_group")
...
class InitiationServiceIntegrationTest(TestCase):
    """Integration tests for the initiation service"""
    ...
    def test_consumer_group_creation(self):
        ...
        try:
            consumer = InitiationQueueConsumer()
